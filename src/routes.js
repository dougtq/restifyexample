...
module.exports = ctx => {
  // extraindo os calores do objeto passadpo
  let db = ctx.db,
    restful = ctx.restful
  ...
  restful.post('/todos', (req, res, next) => {
  ...
  restful.get('/todos', (req, res, next) => {
  ...
  /**
     * Update
     */
  restful.put('/todos/:id', (req, res, next) => {
    // extract data from body and add timestamps
    const data = Object.assign({}, req.body, {
      updated: new Date()
    })
  ...
  /**
    * Delete
  */
  restful.del('/todos/:id', (req, res, next) => {
